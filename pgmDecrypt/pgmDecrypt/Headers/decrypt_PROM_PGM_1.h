...
void pgm_decrypt_kov(UINT16 *src,int rom_size)
{
	int i;
...
void pgm_decrypt_kovsh(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) (machine.root_device(UINT16 *src,int rom_size).memregion("maincpu")->base(UINT16 *src,int rom_size)+0x100000);
...
void pgm_decrypt_photoy2k(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) (machine.root_device(UINT16 *src,int rom_size).memregion("maincpu")->base(UINT16 *src,int rom_size)+0x100000);
...
void pgm_decrypt_pstar(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) (machine.root_device(UINT16 *src,int rom_size).memregion("maincpu")->base(UINT16 *src,int rom_size)+0x100000);
...
void pgm_decrypt_dfront(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_ddp2(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_mm(UINT16 *src,int rom_size) // and dw2001
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_kov2(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_kov2p(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_puzzli2(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) (machine.root_device(UINT16 *src,int rom_size).memregion("maincpu")->base(UINT16 *src,int rom_size)+0x100000);
...
void pgm_decrypt_theglad(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_killbldp(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_svg(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_svgpcb(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *)(machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_py2k2(UINT16 *src,int rom_size) // and ddpdoj/ddpdojbl
{
	int i;
	//UINT16 *src = (UINT16 *) (machine.root_device(UINT16 *src,int rom_size).memregion("maincpu")->base(UINT16 *src,int rom_size)+0x100000);
...
void pgm_decrypt_ket(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) (machine.root_device(UINT16 *src,int rom_size).memregion("maincpu")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_espgal(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) (machine.root_device(UINT16 *src,int rom_size).memregion("maincpu")->base(UINT16 *src,int rom_size));
...
void pgm_decrypt_sdwx(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_hauntedh(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_chessc2(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_klxyj(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_zhongguo(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_gonefsh2(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_sddz(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_lhzb3(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_mgfx(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_lhzb4(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_fearless(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_slqz3(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_fruitpar(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_amazonia(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_amazoni2(UINT16 *src,int rom_size)
{
	int i;
	//UINT16 *src = (UINT16 *) machine.root_device(UINT16 *src,int rom_size).memregion("user1")->base(*);
...
void pgm_decrypt_pgm3in1(UINT16 *PGM68KROM,UINT32 nPGM68KROMLen)
{
...
void pgm_decrypt_happy6in1(UINT16 *PGMUSER0,UINT32 nPGMExternalARMLen)
{
